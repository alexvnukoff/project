...
from b24online.Innov.forms import InnovationProjectForm, AdditionalPageFormSet
...
class InnovationProjectList(ItemsList):
    ...
    def ajax(self, request, *args, **kwargs):
        self.template_name = 'b24online/Innov/contentPage.html'

    def no_ajax(self, request, *args, **kwargs):
        self.template_name = 'b24online/Innov/index.html'
...
class InnovationProjectDetail(ItemDetail):
    model = InnovationProject
    template_name = 'b24online/Innov/detailContent.html'
...
class InnovationProjectUpdate(ItemUpdate):
    ...
    template_name = 'b24online/Innov/addForm.html'
