...
urlpatterns = patterns('',
    # Examples:
     ...
     url(r'^b2c/$', tppcenter.Product.views.get_products_list.as_view(my=True), name='my_main_b2c'),
     url(r'^b2c/page(?P<page>[0-9]+)?/$', tppcenter.Product.views.get_products_list.as_view(my=True), name="my_main_b2c_paginator"),
