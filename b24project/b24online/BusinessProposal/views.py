...
class BusinessProposalList(ItemsList):
    ...
    def ajax(self, request, *args, **kwargs):
        self.template_name = 'b24online/BusinessProposal/contentPage.html'

    def no_ajax(self, request, *args, **kwargs):
        self.template_name = 'b24online/BusinessProposal/index.html'
...
class BusinessProposalDetail(ItemDetail):
    model = BusinessProposal
    template_name = 'b24online/BusinessProposal/detailContent.html'
...
class BusinessProposalUpdate(ItemUpdate):
    ...
    template_name = 'b24online/BusinessProposal/addForm.html'
