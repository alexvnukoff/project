...
urlpatterns = patterns('',
    # Examples:
     ...
     url(r'^tabs/companies/$', tppcenter.Tpp.views._tabsCompanies, name="tab_companies"),
     url(r'^tabs/companies/page(?P<page>[0-9]+)?/$', tppcenter.Tpp.views._tabsCompanies, name="tab_companies_paged"),
