...
urlpatterns = patterns('',
     url(r'^$', b24online.Vacancy.views.RequirementList.as_view(), name='main'),
     ...
     url(r'^my/page(?P<page>[0-9]+)?/$', b24online.Vacancy.views.RequirementList.as_view(my=True), {'my': True}, name="my_main_paginator"),
     ...
     url(r'^(?P<slug>[a-zA-z0-9-]+)-(?P<item_id>[0-9]+)\.html$', b24online.Vacancy.views.RequirementDetail.as_view(), name="detail"),
)
