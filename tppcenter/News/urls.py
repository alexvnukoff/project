...
urlpatterns = patterns('',
    # Examples:
     ...
     url(r'^category/(?P<category>[0-9]+)/$', tppcenter.News.views.get_news_list,  name='news_categories'),
     url(r'^category/(?P<category>[0-9]+)/page(?P<page>[0-9]+)?/$', tppcenter.News.views.get_news_list, name="news_categories_paginator"),
