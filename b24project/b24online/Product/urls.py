...
from b24online.Product.views import (B2BProductList, B2CProductList,
    ...
    B2CProductDetail, B2BProductGalleryImageList, B2XProductGalleryImageList,
...
urlpatterns = [
    ...
    url(r'^tabs/gallery/(?P<type>[b(2b|2c)]{3,})/(?P<item>[0-9]+)/$', B2XProductGalleryImageList.as_view(), name="tabs_gallery"),
    url(r'^tabs/gallery/(?P<type>[b(2b|2c)]{3,})/(?P<item>[0-9]+)/page(?P<page>[0-9]+)/$', B2XProductGalleryImageList.as_view(), name="tabs_gallery_paged"),
    url(r'^tabs/gallery_structure/(?P<type>[b(2b|2c)]{3,})/(?P<item>[0-9]+)/page(?P<page>[0-9]+)/$', B2XProductGalleryImageList.as_view(is_structure=True), name="gallery_structure"),
    url(r'^tabs/gallery/(?P<type>[b(2b|2c)]{3,})/(?P<item>[0-9]+)/remove/(?P<pk>[0-9]+)/$', DeleteB2XProductGalleryImage.as_view(), name="gallery_remove_item"),
