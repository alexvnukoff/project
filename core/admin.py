from core.models import (Action, ActionPath, Attribute, AttrTemplate, Item, Relationship, Dictionary, State, Slot,
                         Process, Value, User)
...
class UserAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_('Personal info'), {'fields': ('date_of_birth', 'first_name', 'last_name', 'avatar')}),
