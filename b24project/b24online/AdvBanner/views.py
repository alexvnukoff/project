...
from b24online.models import BannerBlock, Banner, AdvertisementPrice, AdvertisementOrder, Organization, \
    AdvertisementTarget
from b24online.AdvBanner.forms import BannerForm
from b24online.cbv import ItemCreate


class BannerBlockList(ListView):
    template_name = 'b24online/AdvBanner/index.html'
...
class CreateBanner(ItemCreate):
    ...
    template_name = 'b24online/AdvBanner/addForm.html'
    success_url = None
    ...
    def form_valid(self, form):
        ...
        with transaction.atomic():
            ...
            prices = AdvertisementPrice.objects.filter(price_filter, advertisement_type='banner', dates__contains=now())
...
class OrderDetail(DetailView):
    ...
    template_name = 'b24online/AdvBanner/order.html'
