...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ActionPath'
        db.create_table('core_actionpath', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=128, unique=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Action'], related_name='act2path')),
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Action'], related_name='path2act')),
        ))
        db.send_create_signal('core', ['ActionPath'])

        # Adding model 'Process'
        db.create_table('core_process', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=128, unique=True)),
        ))
        db.send_create_signal('core', ['Process'])

        # Adding model 'Action'
        db.create_table('core_action', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=128, unique=True)),
            ('papa', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Process'], related_name='action')),
            ('child_proc', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Process'], default=0, related_name='start_node')),
        ))
        db.send_create_signal('core', ['Action'])


    def backwards(self, orm):
        # Deleting model 'ActionPath'
        db.delete_table('core_actionpath')

        # Deleting model 'Process'
        db.delete_table('core_process')
    ...
    models = {
        'core.action': {
            ...
            'child_proc': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Process']", 'default': '0', 'related_name': "'start_node'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'papa': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Process']", 'related_name': "'action'"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '128', 'unique': 'True'})
        },
        'core.actionpath': {
            'Meta': {'object_name': 'ActionPath'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Action']", 'related_name': "'act2path'"}),
            'target': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Action']", 'related_name': "'path2act'"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '128', 'unique': 'True'})
        },
        'core.attribute': {
            'Meta': {'object_name': 'Attribute'},
            'created_date': ('django.db.models.fields.DateField', [], {'blank': 'True', 'auto_now_add': 'True'}),
        ...
        'core.identity': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['core.Identity']", 'symmetrical': 'False', 'related_name': "'i2i'", 'through': "orm['core.Participant']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '128', 'unique': 'True'})
        },
        'core.item': {
            'Meta': {'object_name': 'Item'},
            'attr': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['core.Attribute']", 'symmetrical': 'False', 'related_name': "'item'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
