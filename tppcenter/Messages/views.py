...
def view_messages(request, recipient_id=None):
    ...
    if not request.is_ajax():
        ...
        return render_to_response("Messages/index.html", template_params, context_instance=RequestContext(request))
    else:
        ...
        if box is None:
            ...
            return render_to_response("Messages/contentBox.html", template_params,
