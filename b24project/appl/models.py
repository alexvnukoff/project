...
class Product(Item):
    ...
    def getCoupons(querySet=False):
        ...
        if querySet is not False:
            ...
            return Product.active.get_active_related().filter(item2value__attr__title="COUPON_DISCOUNT",
                                                              item2value__title__gt=0,
                                                              item2value__end_date__gt=now,
                                                              item2value__start_date__lte=timeNow)
    ...
    def getProdWithDiscount(querySet=False):
        ...
        if querySet is not False:
            ...
            return Product.active.get_active_related().filter(item2value__attr__title="DISCOUNT",
                                                              item2value__title__gt=0,
                                                              item2value__end_date__isnull=True,
                                                              item2value__start_date__lte=timeNow)
