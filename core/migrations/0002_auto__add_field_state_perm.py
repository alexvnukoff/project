...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'State.perm'
        db.add_column('core_state', 'perm',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Permission'], related_name='state', default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'State.perm'
        db.delete_column('core_state', 'perm_id')
