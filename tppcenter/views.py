...
def buildCountries(request):
    ...
    countries = {'Azerbaydjan': {'NAME': {'title': 'Azerbaydjan', 'title_ru': 'Азербайджан'}, 'COUNTRY_FLAG': "sprite-flag_azerbaijan"},
                 ...
                 'Belarus': {'NAME': {'title': 'Belarus', 'title_ru': 'Беларусь', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_belarus"},
                 'Georgia': {'NAME': {'title': 'Georgia', 'title_ru': 'Грузия', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_georgia"},
                 'Israel': {'NAME': {'title': 'Israel', 'title_ru': 'Израиль', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_israel"},
                 'Kazakhstan': {'NAME': {'title': 'Kazakhstan', 'title_ru': 'Казахстан', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_kazakhstan"},
                 'Kyrgyzstan': {'NAME': {'title': 'Kyrgyzstan', 'title_ru': 'Киргизия', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_kyrgyzstan"},
                 'Latvia': {'NAME': {'title': 'Latvia', 'title_ru': 'Латвия', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_lithuania"},
                 'Lithuania': {'NAME': {'title': 'Lithuania', 'title_ru': 'Литва', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_lithuania"},
                 'Moldova': {'NAME': {'title': 'Moldova', 'title_ru': 'Молдова', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_moldova"},
                 'Russia': {'NAME': {'title': 'Russia', 'title_ru': 'Россия', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_russia"},
                 'Tajikistan': {'NAME': {'title': 'Tajikistan', 'title_ru': 'Таджикистан', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_tajikistan"},
                 'Turkmenistan': {'NAME': {'title': 'Turkmenistan', 'title_ru': 'Туркмения', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_turkmenistan"},
                 'Uzbekistan': {'NAME': {'title': 'Uzbekistan', 'title_ru': 'Узбекистан', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_uzbekistan"},
                 'Ukraine': {'NAME': {'title': 'Ukraine', 'title_ru': 'Украина', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_ukraine"},
                 'Estonia': {'NAME': {'title': 'Estonia', 'title_ru': 'Эстония', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_estonia"},
                 'Afghanistan': {'NAME': {'title': 'Afghanistan', 'title_ru': 'Афганистан', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_afghanistan"},
                 'Albania': {'NAME': {'title': 'Albania', 'title_ru': 'Албания', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_albania"},
                 'Algeria': {'NAME': {'title': 'Algeria', 'title_ru': 'Алжир', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_algeria"},
                 'Andorra': {'NAME': {'title': 'Andorra', 'title_ru': 'Андорра', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_andorra"},
                 'Angola': {'NAME': {'title': 'Angola', 'title_ru': 'Ангола', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_angola"},
                 'Antigua and Barbuda': {'NAME': {'title': 'Antigua and Barbuda', 'title_ru': 'Антигуа и Барбуда', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_antigua_and_barbuda"},
                 'Argentina': {'NAME': {'title': 'Argentina', 'title_ru': 'Аргентина', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_argentina"},
                 'Australia': {'NAME': {'title': 'Australia', 'title_ru': 'Австралия', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_australia"},
                 'Austria': {'NAME': {'title': 'Austria', 'title_ru': 'Австрия', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_austria"},
                 'Bahamas': {'NAME': {'title': 'Bahamas', 'title_ru': 'Багамские острова', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_bahamas"},
                 'Bahrain': {'NAME': {'title': 'Bahrain', 'title_ru': 'Бахрейн', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_bahrain"},
                 'Bangladesh': {'NAME': {'title': 'Bangladesh', 'title_ru': 'Бангладеш', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_bangladesh"},
                 'Barbados': {'NAME': {'title': 'Barbados', 'title_ru': 'Барбадос', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_barbados"},
                 'Belgium': {'NAME': {'title': 'Belgium', 'title_ru': 'Бельгия', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_belgium"},
                 'Belize': {'NAME': {'title': 'Belize', 'title_ru': 'Белиз', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_belize"},
                 'Benin': {'NAME': {'title': 'Benin', 'title_ru': 'Бенин', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_benin"},
                 'Bhutan': {'NAME': {'title': 'Bhutan', 'title_ru': 'Бутан', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_bhutan"},
                 'Bolivia': {'NAME': {'title': 'Bolivia', 'title_ru': 'Боливия', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_bolivia"},
                 'Bosnia and Herzegovina': {'NAME': {'title': 'Bosnia and Herzegovina', 'title_ru': 'Босния и Герцеговина', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_bosnia_and_herzegovina"},
                 'Botswana': {'NAME': {'title': 'Botswana', 'title_ru': 'Ботсвана', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_botswana"},
                 'Brazil': {'NAME': {'title': 'Brazil', 'title_ru': 'Бразилия', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_brazil"},
                 'Brunei': {'NAME': {'title': 'Brunei', 'title_ru': 'Бруней', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_brunei"},
                 'Bulgaria': {'NAME': {'title': 'Bulgaria', 'title_ru': 'Болгария', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_bulgaria"},
                 'Burkina Faso': {'NAME': {'title': 'Burkina Faso', 'title_ru': 'Буркина-Фасо', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_burkina_faso"},
                 'Burundi': {'NAME': {'title': 'Burundi', 'title_ru': 'Бурунди', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_burundi"},
                 'Cambodia': {'NAME': {'title': 'Cambodia', 'title_ru': 'Камбоджа', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_cambodia"},
                 'Cameroon': {'NAME': {'title': 'Cameroon', 'title_ru': 'Камерун', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_cameroon"},
                 'Canada': {'NAME': {'title': 'Canada', 'title_ru': 'Канада', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_canada"},
                 'Cape Verde': {'NAME': {'title': 'Cape Verde', 'title_ru': 'Кабо-Верде', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_cape_verde"},
                 'Central African Republic': {'NAME': {'title': 'Central African Republic', 'title_ru': 'Центрально-Африканская Республика', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_central_african_republic"},
                 'Chad': {'NAME': {'title': 'Chad', 'title_ru': 'Чад', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_chad"},
                 'Chile': {'NAME': {'title': 'Chile', 'title_ru': 'Чили', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_chile"},
                 'China': {'NAME': {'title': 'China', 'title_ru': 'Китай', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_china"},
                 'Columbia': {'NAME': {'title': 'Columbia', 'title_ru': 'Колумбия', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_colombia"},
                 'Comoros': {'NAME': {'title': 'Comoros', 'title_ru': 'Коморские острова', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_comoros"},
                 'Democratic Republic of Congo': {'NAME': {'title': 'Democratic Republic of Congo', 'title_ru': 'Демократическая Республика Конго', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_congo_democratic_republic"},
                 'Congo Republic': {'NAME': {'title': 'Congo Republic', 'title_ru': 'Республика Конго', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_congo_republic"},
                 'Cook Island': {'NAME': {'title': 'Cook Island', 'title_ru': 'острова Кука', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_cook_islands"},
                 'Costa Rica': {'NAME': {'title': 'Costa Rica', 'title_ru': 'Коста-Рика', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_costa_rica"},
                 "Cote D'ivoire": {'NAME': {'title': "Cote D'ivoire", 'title_ru': 'Берег Слоновой Кости', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_cote_divoire"},
                 'Croatia': {'NAME': {'title': 'Croatia', 'title_ru': 'Хорватия', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_croatia"},
                 'Cuba': {'NAME': {'title': 'Cuba', 'title_ru': 'Куба', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_cuba"},
                 'Cyprus': {'NAME': {'title': 'Cyprus', 'title_ru': 'Кипр', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_cyprus"},
                 'Czech Republic': {'NAME': {'title': 'Czech Republic', 'title_ru': 'Чешская республика', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_czech_republic"},
                 'Denmark': {'NAME': {'title': 'Denmark', 'title_ru': 'Дания', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_denmark"},
                 'Djibouti': {'NAME': {'title': 'Djibouti', 'title_ru': 'Джибути', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_djibouti"},
                 'Dominica': {'NAME': {'title': 'Dominica', 'title_ru': 'Доминика', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_dominica"},
                 'Dominican Republic': {'NAME': {'title': 'Dominican Republic', 'title_ru': 'Доминиканская Республика', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_dominican_republic"},
                 'East Timor': {'NAME': {'title': 'East Timor', 'title_ru': 'Восточный Тимор', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_east_timor"},
                 'Egypt': {'NAME': {'title': 'Egypt', 'title_ru': 'Египет', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_egypt"},
                 'El Salvador': {'NAME': {'title': 'El Salvador', 'title_ru': 'Сальвадор', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_el_salvador"},
                 'Ecuador': {'NAME': {'title': 'Ecuador', 'title_ru': 'Эквадор', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_equador"},
                 'Equatorial Guinea': {'NAME': {'title': 'Equatorial Guinea', 'title_ru': 'Экваториальная Гвинея', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_equatorial_guinea"},
                 'Eritrea': {'NAME': {'title': 'Eritrea', 'title_ru': 'Эритрея', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_eritrea"},
                 'Ethiopia': {'NAME': {'title': 'Ethiopia', 'title_ru': 'Эфиопия', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_ethiopia"},
                 'Federated State of Micronesia': {'NAME': {'title': 'Federated State of Micronesia', 'title_ru': 'Федеративные Штаты Микронезии', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_federated_states_of_micronesia"},
                 'Fiji': {'NAME': {'title': 'Fiji', 'title_ru': 'Фиджи', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_fiji"},
                 'Finland': {'NAME': {'title': 'Finland', 'title_ru': 'Финляндия', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_finland"},
                 'France': {'NAME': {'title': 'France', 'title_ru': 'Франция', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_france"},
                 'Gabon': {'NAME': {'title': 'Gabon', 'title_ru': 'Габон', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_gabon"},
                 'Gambia': {'NAME': {'title': 'Gambia', 'title_ru': 'Гамбия', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_gambia"},
                 'Germany': {'NAME': {'title': 'Germany', 'title_ru': 'Германия', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_germany"},
                 'Ghana': {'NAME': {'title': 'Ghana', 'title_ru': 'Гана', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_ghana"},
                 'Greece': {'NAME': {'title': 'Greece', 'title_ru': 'Греция', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_greece"},
                 'Grenada': {'NAME': {'title': 'Grenada', 'title_ru': 'Гренада', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_grenada"},
                 'Guatemala': {'NAME': {'title': 'Guatemala', 'title_ru': 'Гватемала', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_guatemala"},
                 'Guinea': {'NAME': {'title': 'Guinea', 'title_ru': 'Гвинея', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_guinea"},
                 'Guinea Bissau': {'NAME': {'title': 'Guinea Bissau', 'title_ru': 'Гвинея-Бисау', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_guinea_bissau"},
                 'Guyana': {'NAME': {'title': 'Guyana', 'title_ru': 'Гайана', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_guyana"},
                 'Haiti': {'NAME': {'title': 'Haiti', 'title_ru': 'Гаити', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_haiti"},
                 'Honduras': {'NAME': {'title': 'Honduras', 'title_ru': 'Гондурас', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_honduras"},
                 'Hungary': {'NAME': {'title': 'Hungary', 'title_ru': 'Венгрия', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_hungary"},
                 'Iceland': {'NAME': {'title': 'Iceland', 'title_ru': 'Исландия', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_iceland"},
                 'India': {'NAME': {'title': 'India', 'title_ru': 'Индия', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_india"},
                 'Indonesia': {'NAME': {'title': 'Indonesia', 'title_ru': 'Индонезия', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_indonesia"},
                 'Iran': {'NAME': {'title': 'Iran', 'title_ru': 'Иран', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_iran"},
                 'Iraq': {'NAME': {'title': 'Iraq', 'title_ru': 'Ирак', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_iraq"},
                 'Ireland': {'NAME': {'title': 'Ireland', 'title_ru': 'Ирландия', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_ireland"},
                 'Italy': {'NAME': {'title': 'Italy', 'title_ru': 'Италия', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_italy"},
                 'Jamaica': {'NAME': {'title': 'Jamaica', 'title_ru': 'Ямайка', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_jamaica"},
                 'Japan': {'NAME': {'title': 'Japan', 'title_ru': 'Япония', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_japan"},
                 'Jordan': {'NAME': {'title': 'Jordan', 'title_ru': 'Иордания', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_jordan"},
                 'Kenya': {'NAME': {'title': 'Kenya', 'title_ru': 'Кения', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_kenya"},
                 'Kiribati': {'NAME': {'title': 'Kiribati', 'title_ru': 'Кирибати', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_kiribati"},
                 'Kuwait': {'NAME': {'title': 'Kuwait', 'title_ru': 'Кувейт', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_kuwait"},
                 'Laos': {'NAME': {'title': 'Laos', 'title_ru': 'Лаос', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_laos"},
                 'Lebanon': {'NAME': {'title': 'Lebanon', 'title_ru': 'Ливан', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_lebanon"},
                 'Lesotho': {'NAME': {'title': 'Lesotho', 'title_ru': 'Лесото', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_lesotho"},
                 'Liberia': {'NAME': {'title': 'Liberia', 'title_ru': 'Либерия', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_liberia"},
                 'Libya': {'NAME': {'title': 'Libya', 'title_ru': 'Ливия', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_libya"},
                 'Liechtenstein': {'NAME': {'title': 'Liechtenstein', 'title_ru': 'Лихтенштейн', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_liechtenstein"},
                 'Luxembourg': {'NAME': {'title': 'Luxembourg', 'title_ru': 'Люксембург', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_luxembourg"},
                 'Macedonia': {'NAME': {'title': 'Macedonia', 'title_ru': 'Македония', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_macedonia"},
                 'Madagascar': {'NAME': {'title': 'Madagascar', 'title_ru': 'Мадагаскар', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_madagascar"},
                 'Malawi': {'NAME': {'title': 'Malawi', 'title_ru': 'Малави', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_malawi"},
                 'Malaysia': {'NAME': {'title': 'Malaysia', 'title_ru': 'Малайзия', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_malaysia"},
                 'Maldives': {'NAME': {'title': 'Maldives', 'title_ru': 'Мальдивы', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_maledives"},
                 'Mali': {'NAME': {'title': 'Mali', 'title_ru': 'Мали', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_mali"},
                 'Malta': {'NAME': {'title': 'Malta', 'title_ru': 'Мальта', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_malta"},
                 'Marshall Islands': {'NAME': {'title': 'Marshall Islands', 'title_ru': 'Маршалловы острова', "title_en": "Armenia"}, 'COUNTRY_FLAG': "sprite-flag_marshall_islands"},
